...
Usage:
  .\build-windows.ps1 -Version 3.12
  .\build-windows.ps1 -Version 3.12 -Arch x86_64
  .\build-windows.ps1 -Version 3.12 -AppsDir "$env:USERPROFILE\Apps"
  .\build-windows.ps1 -Version 3.12 -KeepBuildDirs
